 ...
 * @var string $badge
 * @var string $title
 * @var string $headingTag 'h1' by default; pass 'p' when the page's real h1
 *                         lives in the content (e.g. dosen name on detail pages)
 */
...
<div class="relative bg-forest-900 py-16 lg:py-20 overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        <div data-reveal>
            ...
            <<?= $headingTag ?> class="font-display text-3xl md:text-5xl font-bold text-white tracking-tight"><?= e($title) ?></<?= $headingTag ?>>
